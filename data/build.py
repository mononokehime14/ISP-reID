...
from .collate_batch import train_collate_fn, val_collate_fn, clustering_collate_fn, val_collate_fn_self
from .datasets import init_dataset, ImageDataset, ImageDataset_train,ValImageDataset
...
def make_data_loader(cfg):
    ...
    clustering_loader = DataLoader(
        ...
        collate_fn=clustering_collate_fn, pin_memory=True
    )
...
def make_val_loader(cfg):
    ...
    val_loader = DataLoader(
        val_set, batch_size=cfg.TEST.IMS_PER_BATCH, shuffle=False, num_workers=num_workers,
        collate_fn=val_collate_fn_self, pin_memory=True
    )
